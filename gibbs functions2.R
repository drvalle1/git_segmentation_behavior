...
get.summary.stats2=function(breakpt,dat,max.Vp,max.Vt){ #to change Vp to multinomial
  breakpt1=c(0,breakpt,Inf)
  n=length(breakpt1)
...
#---------------------------------------------
log.marg.likel2=function(alpha,summary.stats,max.Vp,max.Vt){ #to change Vp to multinomial
  #get ratio for Vp
...
#---------------------------------------------
samp.move2=function(breakpt,max.time,dat,alpha,max.Vp,max.Vt){ #to change Vp to multinomial
  breakpt.old=breakpt
  p=length(breakpt)
  rand1=runif(1)	
  p0=1
  ...
  #get sufficient statistics
  stats.old=get.summary.stats2(breakpt=breakpt.old,dat=dat,max.Vp=max.Vp,max.Vt=max.Vt)
  stats.new=get.summary.stats2(breakpt=breakpt.new,dat=dat,max.Vp=max.Vp,max.Vt=max.Vt)
  
  #get marginal loglikel
  pold=log.marg.likel2(alpha=alpha,summary.stats=stats.old,max.Vp=max.Vp,max.Vt=max.Vt)
  pnew=log.marg.likel2(alpha=alpha,summary.stats=stats.new,max.Vp=max.Vp,max.Vt=max.Vt)+log(p0)
  prob=exp(pnew-pold)
  rand2=runif(1)
